  ...
  return (
    <footer id="contact" className="py-24 px-8 border-t border-amber-900/40 bg-[#050505] relative z-30 text-center overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto relative z-10 space-y-16">
        <div className="font-samarkan text-4xl md:text-8xl text-amber-500 font-black tracking-widest gold-glow uppercase">
          CITADEL 1.0
        </div>
        ...
        <div className="pt-8">
            <div className="font-samarkan text-amber-900/20 text-6xl md:text-[10rem] select-none uppercase font-black pointer-events-none tracking-widest">
                ॐ CITADEL ॐ
            </div>
        </div>
      </div>
