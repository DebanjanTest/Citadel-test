...
const About: React.FC = () => {
  ...
  return (
    <section id="about" ref={sectionRef} className="pt-8 pb-24 md:pb-32 px-6 md:px-12 lg:px-24 relative overflow-hidden border-t-0 border-b border-amber-900/20 bg-black/30 backdrop-blur-sm">
